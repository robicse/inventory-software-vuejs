...
class CashRegisterController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (CashRegister::store([
            ...
            $response = [
                'message' => Lang::get('lang.cash_register') . ' ' . Lang::get('lang.successfully_saved')
            ];
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($cashRegister) {
            ...
            $response = [
                'message' => Lang::get('lang.cash_register') . ' ' . Lang::get('lang.successfully_updated')
            ];
            return response()->json($response, 201);
    ...
    public function deleteCashRegister($id)
    {
        ...
        if ($used == 0) {
            ...
            $response = [
                'message' => Lang::get('lang.cash_register') . ' ' . Lang::get('lang.successfully_deleted')
            ];

            return response()->json($response, 200);
        } else {
            $response = [
                'message' => Lang::get('lang.cash_register') . ' ' . Lang::get('lang.in_use') . ', ' . Lang::get('lang.you_can_not_delete_the') . ' ' . strtolower(Lang::get('lang.cash_register'))
            ];
