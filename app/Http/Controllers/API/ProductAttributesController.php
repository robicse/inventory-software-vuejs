...
class ProductAttributesController extends Controller
{
    ...
    public function storeAttribute(Request $request)
    {
        ...
        if ($productAttribute = ProductAttribute::store([
            ...
            $response = [
                'message' => Lang::get('lang.product_attributes') . ' ' . Lang::get('lang.successfully_saved')
            ];
    ...
    public function updateAttribute(Request $request, $id)
    {
        ...
        if ($productAttribute) {
            ...
            $response = [
                'message' => Lang::get('lang.product_attributes') . ' ' . Lang::get('lang.successfully_updated')
            ];
    ...
    public function deleteAttribute($id)
    {
        ...
        if ($used == 0) {
            ...
            $response = [
                'message' => Lang::get('lang.product_attributes') . ' ' . Lang::get('lang.successfully_deleted')
            ];

            return response()->json($response, 201);
        } else {
            $response = [
                'message' => Lang::get('lang.product_attributes') . ' ' . Lang::get('lang.in_use') . ', ' . Lang::get('lang.you_can_not_delete_the') . ' ' . strtolower(Lang::get('lang.product_attributes'))
            ];
