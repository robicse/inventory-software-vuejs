                            ...
                            <div class="main-layout-card-content pb-0 mb-0">
                                ...
                                <div class="text-center">
                                    ...
                                    <img class="img-fluid profile-image rounded-circle avatar mb-4"
                                         :src="publicPath+'/uploads/profile/'+customer.avatar" alt="" width="50%" v-else>
                                </div>
                            </div>
                            ...
                            <div class="main-layout-card-content pt-0 mt-0">
                                <div class="text-center user-name-text">
                                    <div class="card text-center">
                                        ...
                                        <div class="card-body">
                                            <ul class="list-group">
                                                <p class="list-group-item cursor-text contact-border"  v-if="customer.fullName">
                                                    <i class="fa fa-check"></i> {{ customer.fullName }}
                                                </p>
                                                <p class="list-group-item cursor-text contact-border"  v-if="customer.company">
                                                    <i class="la la-building"></i> {{customer.company }}
                                                </p>
                                                <p class="list-group-item cursor-text contact-border"  v-if="customer.email">
                                                    <i class="la la-envelope"></i> {{customer.email }}
                                                </p>
                                                <p class="list-group-item cursor-text contact-border"  v-if="customer.phone_number">
                                                    <i class="la la-phone"></i> {{customer.phone_number }}
                                                </p>
                                                <p class="list-group-item cursor-text contact-border"  v-if="customer.customer_code">
                                                    <i class="la la-barcode"></i> {{customer.customer_code }}
                                                </p>
                                                <p class="list-group-item cursor-text contact-border"  v-if="customer.customer_group_title">
