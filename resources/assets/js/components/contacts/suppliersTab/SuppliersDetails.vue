                            ...
                            <div class="main-layout-card-content pt-0 mt-0">
                                <div class="text-center user-name-text">
                                    <div class="card text-center">
                                        ...
                                        <div class="card-body">
                                            <ul class="list-group">
                                                <p class="list-group-item cursor-text contact-border"  v-if="supplier.fullName">
                                                    <i class="fa fa-check"></i> {{ supplier.fullName }}
                                                </p>
                                                <p class="list-group-item cursor-text contact-border"  v-if="supplier.company">
                                                    <i class="la la-building"></i> {{supplier.company }}
                                                </p>
                                                <p class="list-group-item cursor-text contact-border"  v-if="supplier.email">
                                                    <i class="la la-envelope"></i> {{supplier.email }}
                                                </p>
                                                <p class="list-group-item cursor-text contact-border"  v-if="supplier.phone_number">
                                                    <i class="la la-phone"></i> {{supplier.phone_number }}
                                                </p>
                                                <p class="list-group-item cursor-text contact-border"  v-if="supplier.customer_code">
                                                    <i class="la la-barcode"></i> {{supplier.customer_code }}
                                                </p>
                                                <p class="list-group-item cursor-text contact-border"  v-if="supplier.customer_group_title">
                        ...
                        <div class="main-layout-card">
                            ...
                            <div class="main-layout-card-content">
                                <datatable-component class="main-layout-card-content" :options="tableOptions" :exportData="exportToVue"
                                                     exportFileName="supplier_record" @resetStatus="resetExportValue"></datatable-component>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            return {
                ...
                tableOptions: {
                    ...
                    columns: [
                        ...
                        {title: 'lang.vat',                 key: 'vat',             type: 'text', sortable: false},
