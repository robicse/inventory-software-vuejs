        ...
        <div class="line-header">
            <div class="form-row">
                <div class="col-12 col-sm-4">
                    ...
                    <div class="input-field">
                        <div class="sales-filter-menu">
                            <select id="employee" v-model="user" @change="onChange($event)" class="form-control">
                                <option value="">{{ trans('lang.all') }}</option>
                                <option v-for="user in users" :value="user.id">{{ user.first_name+' '+user.last_name
                                    }}
                                </option>
                            </select>
                        </div>
                ...
                <div class="col-12 col-sm-4">
                    ...
                    <div class="input-field">
                        <div class="sales-filter-menu">
                            <select id="branch" v-model="branch" @change="onChange($event)" class="form-control">
                                <option value="">{{ trans('lang.all') }}</option>
                ...
                <div class="col-12 col-sm-4">
                    ...
                    <div class="input-field">
                        <div class="sales-filter-menu">
                            <select id="year" v-model="duration" @change="onChange($event)" class="form-control">
