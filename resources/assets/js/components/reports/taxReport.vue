    ...
    <div>
        ...
        <span v-else>
            ...
            <div class="main-layout-card-header-with-button">
                <div class="main-layout-card-content-wrapper">
                    <div class="main-layout-card-header-contents">
                        <h5 class="m-0">{{ trans('lang.vates') }}</h5>
                    </div>
            ...
            <datatable-component class="main-layout-card-content"
                                 ...
                                 :exportFileName="trans('lang.vates')"
                        ...
                        if (response.data) {
                            ...
                            instance.tableOptions = {
                                ...
                                columns: [
                                    ...
                                    {title: 'lang.vat_date', key: 'date', type: 'text', sortable: true},
                                    ...
                                    {title: 'lang.vat', key: 'tax', type: 'text', sortable: true},
                                ],
                                source: '/tax-report',
                                summary: true,
                                search:true,
