        ...
        <div class="modal-layout-content">
            <form class="form-row margin-top">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select v-validate="'required'" v-model="cardType" name="card_type" data-vv-as="type" class="form-control"
                            id="cardType">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select v-validate="'required'" v-model="month" name="transaction_month" data-vv-as="month" class="form-control" id="month">
