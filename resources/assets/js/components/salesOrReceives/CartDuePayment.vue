        ...
        <div v-else>
            <div class="row mb-3">
                ...
                <div class="col-md-8 pl-0">
                    <payment-input id="'paid'" v-if="PaymentGauard" :inputValue="decimalFormat(paid)"
                                   @input="getPaymentAmount"></payment-input>
                </div>
            </div>
            <div class="row mb-3">
                <label class="col-md-4 col-form-label">{{trans('lang.payment_method')}}</label>
                <div class="col-md-8 pl-0">
                    <select class="form-control"
                            id="exampleFormControlSelect1" v-model="selectedPayment">
                ...
                instance.axiosGETorPOST(
                    ...
                    (success, responseData) => { // callback after axios method call
                        if (success) //response after then function
                        {
                           ...
                           let paymentRow =  instance.paymentList.find(function (element) {
