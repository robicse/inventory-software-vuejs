               ...
               <div class="mb-3">
                   ...
                   <div class="form-row">
                       <div class="form-group col-md-5">
                           ...
                           <input type="text" class="form-control" id="app-name" v-model="item.app_name">
                       </div>
                       <div class="form-group offset-md-1 col-md-5">
                           <label>{{ trans('lang.change_app_logo') }}</label>
                           <div class="custom-file">
                               <input type="file" class="custom-file-input" id="app-logo" accept="image/*" @change="appLogo">
                               <label class="custom-file-label text-truncate" for="app-logo">{{ trans('lang.image_only') }}</label>
                           </div>
                       </div>
                   </div>
                   <div class="form-row">
                       <div class="form-group col-md-5">
                           ...
                           <select id="rows-per-table" v-model="item.max_row_per_table" class="form-control" >
                       ...
                       <div class="form-group offset-md-1 col-md-5">
                           ...
                           <div class="custom-file">
                               <input type="file" class="custom-file-input" id="background-image" accept="image/*" @change="backgroundImage">
                               <label class="custom-file-label text-truncate" for="background-image">{{ trans('lang.image_only') }}</label>
                           </div>
                       </div>
                   </div>
               </div>
                   ...
                   <div class="form-row">
                       <div class="form-group col-md-5">
                           ...
                           <div class="form-check">
                               <input class="form-check-input" v-model="item.time_format" type="radio" name="time-format" id="time-format-1" value="24h">
                               <label for="time-format-1" class="radio-button-label">{{ trans('lang.24h') }}</label>
                               <input class="form-check-input" v-model="item.time_format" type="radio" name="time-format" id="time-format-2" value="12h">
                               <label for="time-format-2" class="radio-button-label">{{ trans('lang.12h') }}</label>
                           </div>
                       </div>
                       <div class="form-group offset-md-1 col-md-5">
                           <label for="date-format">{{ trans('lang.date-format') }}</label>
                           <select id="date-format" v-model="item.date_format" class="form-control" data-live-search="true">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-5">
                            ...
                            <input type="text" class="form-control" id="currency-symbol" v-model="item.currency_symbol" value="$">
                        </div>
                        <div class="form-group offset-md-1 col-md-5">
                            <label for="currency-position">{{ trans('lang.currency_position') }}</label>
                            <select id="currency-position" v-model="item.currency_format" class="form-control">
                    ...
                    <div class="form-row">
                        <div class="form-group  col-md-5">
                            ...
                            <select id="decimal-separator" name="thousand-separator" class="form-control" v-model="item.decimal_separator">
                                <option value="" disabled selected>{{ trans('lang.choose_one') }}</option>
                        ...
                        <div class="form-group offset-md-1 col-md-5">
                            ...
                            <select id="thousand-separator" name="thousand-separator" class="form-control" v-model="item.thousand_separator">
                                <option value="" disabled selected>{{ trans('lang.choose_one') }}</option>
                        ...
                        <div class="form-group col-md-5">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" v-model="item.number_of_decimal" type="radio" id="number-of-decimal-0" value="0">
                                <label for="number-of-decimal-0" class="radio-button-label"> 0 </label>
                                <input class="form-check-input" v-model="item.number_of_decimal" type="radio" id="number-of-decimal-2" value="2">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-5">
                            ...
                            <select id="language" class="form-control" v-model="item.language_setting">
                                <option value="" disabled selected>{{ trans('lang.choose_one') }}</option>
                                <option v-for="language in languages" :value="language">{{ language.charAt(0).toUpperCase() + language.slice(1) }}</option>
                            </select>
                        </div>
                        <div class="form-group offset-md-1 col-md-5">
                            <label>{{ trans('lang.clear_language_cache') }}</label>
                                <button type="submit" class="btn btn-light" @click.prevent="clearLanguageCache()">
                                    {{ trans('lang.clear_language_cache') }}
                                </button>
                        </div>
                    </div>
                </div>
                <button type="submit" class="btn btn-primary app-color mobile-btn" @click.prevent="appSettingsUpdate()">{{ trans('lang.save') }}</button>
            </form>
        </div>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            clearLanguageCache()
            {
                ...
                this.axiosGet('/clear-language-cache',
                    function(response){
                        instance.showSuccessAlert(instance.trans('lang.the_language_cache_has_been_removed'));
                        instance.hidePreloader='hide';
                    });
            },
            ...
            appSettingsUpdate()
            {
                ...
                this.axiosPost('/basic-setting',this.inputFields,
                    function(response){
                        instance.hidePreloader ='hide';
