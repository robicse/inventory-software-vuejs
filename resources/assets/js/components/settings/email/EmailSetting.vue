                ...
                <div class="form-row">
                    <div class="form-group col-md-5">
                        ...
                        <input type="text" v-validate="'required'" name="name" class="form-control"
                               id="application-name" v-model="applicationName" :class="{ 'is-invalid': submitted && errors.has('name') }">
                    ...
                    <div class="form-group offset-md-1 col-md-5">
                        ...
                        <input id="email" v-model="email" v-validate="'required|email'" name="email" type="email" class="form-control" :class="{ 'is-invalid': submitted && errors.has('email') }">
                    ...
                    <div class="form-group col-md-5 margin-top">
                        ...
                        <select id="email-driver" v-validate="'required'" name="driver" class="form-control"
                    ...
                    <div class="form-group offset-md-1 col-md-5  margin-top" v-show="emailDriver === 'smtp'">
                    ...
                    <div class="form-group offset-md-1 col-md-5  margin-top" v-show="emailDriver === 'smtp'">
                        ...
                        <div class="heightError">
                            <small class="text-danger" v-show="errors.has('password')">{{ errors.first('password') }}
                            </small>
                        </div>
                    </div>
                    <div class="form-group col-md-5  margin-top" v-show="emailDriver === 'smtp'">
                        ...
                        <select id="encryption-type" v-validate="{required:isSmtpActive}" name="encryption"
                                class="form-control" v-model="emailEncryptionType">
                            <option value="" disabled>{{ trans('lang.choose_one') }}</option>
                            <option value="tls">{{ trans('lang.tls') }}</option>
                            <option value="ssh">{{ trans('lang.ssh') }}</option>
                        </select>
                        <div class="heightError">
                            <small class="text-danger" v-show="errors.has('encryption')">{{ errors.first('encryption') }}</small>
                        </div>
                    </div>
                    <!--mailgun -->
                    <div class="form-group offset-md-1 col-md-5 margin-top" v-show="emailDriver === 'mailgun'">
                        <label for="mailgun-domain">{{ trans('lang.mailgun_domain') }}</label>
                        <input id="mailgun-domain" v-validate="{required:isMailgunActive}" name="domain" v-model="mailgunDomain" data-vv-as="mailgun domain" type="text" class="form-control">
                        <div class="heightError">
                    ...
                    <div class="form-group  col-md-5 margin-top" v-show="emailDriver === 'mailgun'">
                        ...
                        <input id="mailgun-api" v-model="mailgunApi" v-validate="{required:isMailgunActive}" name="mailgunApi" data-vv-as="mailgun API" type="text" class="form-control">
                        <div class="heightError">
                            <small class="text-danger" v-show="errors.has('mailgunApi')">{{ errors.first('mailgunApi')}}</small>
                        </div>
                    </div>
                    <!--test mail-->
                    ...
                    <div class="form-group  col-md-5 margin-top" v-show="emailDriver === 'mandrill'">
                        ...
                        <input id="mandrill-api" v-model="mandrill" v-validate="{required:isMandrilActive}" name="mandrill" data-vv-as="mandrill API" type="text" class="form-control">
                        <div class="heightError">
                            <small class="text-danger" v-show="errors.has('mandrill')">{{ errors.first('mandrill')}}</small>
                        </div>
                    </div>
                    <!--sparkpost-->
                    <div class="form-group  col-md-5 margin-top" v-show="emailDriver === 'sparkpost'">
                    <label for="sparkpost-api">{{ trans('lang.sparkpost_api') }}</label>
                    <input id="sparkpost-api" v-model="sparkpost" v-validate="{required:isSparkpostActive}" name="sparkpost" data-vv-as="sparkpost API" type="text" class="form-control">
                    <div class="heightError">
                        <small class="text-danger" v-show="errors.has('sparkpost')">{{ errors.first('sparkpost')}}</small>
                    </div>
                </div>

                </div>
                <button type="submit" class="btn btn-primary app-color mobile-btn"
                        @click.prevent="updateEmailSetting()">{{ trans('lang.save') }}
                </button>
            </form>
        </div>
    </div>
            ...
            updateEmailSetting() {
                ...
                this.$validator.validateAll().then((result) => {
                    if (result) {
                        ...
                        instance.postDataMethod('/emailsetting', instance.inputFields);
                    }
                });
            },
