<template>
    <div class="main-layout-card">
        <div class="main-layout-card-header-with-button">
            <div class="main-layout-card-content-wrapper">
                ...
                <div class="main-layout-card-header-contents text-right">
                    <button class="btn btn-primary app-color" data-toggle="modal" data-target="#payment-add-edit-modal"
        ...
        <!-- Modal -->
        <div class="modal fade" id="payment-add-edit-modal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered short-modal-dialog" role="document">
                <payment-type-details class="modal-content" v-if="isActive" :id="selectedItemId"
                                      :allPaymentTypes="allPaymentTypes" :modalID="modalID"></payment-type-details>
            </div>
        </div>

        <!-- Delete Modal -->
        <confirmation-modal id="confirm-delete" :message="'this_payment_method_deleted_permanently'"
    ...
    export default {
        ...
        data() {
            return {
                ...
                tableOptions: {
                    ...
                    columns: [
                        {title: 'lang.type', key: 'name', type: 'text', sortable: true},
                        {
                            title: 'lang.action',
                            type: 'component',
                            key: 'action',
        ...
        methods: {
            ...
            confirmationModalButtonAction() {
                this.deleteDataMethod('/delete-payment/' + this.deleteID, this.deleteIndex);
            },
