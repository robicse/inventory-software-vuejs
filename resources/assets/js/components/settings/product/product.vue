    ...
    <div class="main-layout-card">
        ...
        <div class="main-layout-card-content">
            ...
            <form v-else>
                <div class="mb-3">
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" v-validate="'required'" name="reorder" data-vv-as="re-order" class="form-control" id="re-order" v-model="reOrder">
                            <div class="heightError">
                                <small class="text-danger" v-show="errors.has('reorder')">{{ errors.first('reorder') }}</small>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                ...
                <button type="submit" class="btn btn-primary app-color mobile-btn" @click.prevent="productSettingUpdate()">{{ trans('lang.save') }}</button>
            </form>
        </div>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        methods: {
            getProductSettings() {
                let instance = this;
                instance.axiosGet('/product-setting',
                    function (response) {
            ...
            productSettingUpdate() {
                this.$validator.validateAll().then((result) => {
                    if (result) {
                        ...
                        this.axiosPost('/product-setting-save',
                            {
