        ...
        <div class="main-layout-card-header-with-button">
            <div class="main-layout-card-content-wrapper">
                ...
                <div class="main-layout-card-header-contents text-right">
                    <button class="btn btn-primary app-color"  data-toggle="modal" data-target="#role-add-edit-modal" @click.prevent="addEditAction('')">
                        {{ trans('lang.add') }}
                    </button>
                </div>
            </div>
            ...
            return {
                ...
                tableOptions: {
                    ...
                    columns: [
                        ...
                        {title: 'lang.action', type: 'component', key:'action' ,componentName: 'roles-action-component'}
                    ],
                    source: '/roles-list',
                    right_align:'action',
                },
