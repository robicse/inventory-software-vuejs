            ...
            <div class="text-center">
                <div class="d-table w-100 large-loader-container">
                    <div class="d-table-cell align-middle">
                        ...
                        <h5 class="center-align mt-1" v-if="!installingVersion">{{ trans('lang.checking_for_updates')}}</h5>
                        <h5 class="center-align mt-1" v-else>{{ trans('lang.installing_version') +' '+installingVersion}}</h5>
                    </div>
                </div>
            </div>
        </div>
